...
<main id="content" class="wrapper layout-page">
    ...
    <p class="text-white mb-8 fw-semibold fs-4">Find Inspration</p><h1 class="mb-15 text-white hero-title-2 fw-500">Body Daily<br>Oil Wash</h1>
    </div>
    <a href="#" data-animate="fadeInUp" class="pb-2 bg-transparent fw-semibold text-decoration-none hero-link btn btn-link p-0 text-white">
    Discover Now
    <svg class="icon">
    ...
    <div class="lazy-bg bg-overlay position-absolute z-index-1 w-100 h-100  " data-bg-src="assets/images/hero-slider/hero-slider-04.jpg">
    </div><div data-animate="fadeInDown" class="hero-creative-dots position-absolute bottom-0 mb-7 start-50 translate-middle-x"><span class="fs-5 fw-semibold text-white px-5 active active-first">01.</span><span class="fs-5 fw-semibold text-white px-5 ">02.</span><span class="fs-5 fw-semibold text-white px-5 ">03.</span></div></div>
    <div class="vh-100 d-flex align-items-center">
    <div class="z-index-2 container container-xxl py-21 pt-xl-10 pb-xl-11">
    <div class="hero-content text-start">
    <div data-animate="fadeInDown">
    <p class="text-white mb-8 fw-semibold fs-4">Shop Our Set</p><h1 class="mb-15 text-white hero-title-2 fw-500">The 3-Step<br>Skincare Routine</h1>
    </div>
    <a href="#" data-animate="fadeInUp" class="pb-2 bg-transparent fw-semibold text-decoration-none hero-link btn btn-link p-0 text-white">
    Discover Now
    <svg class="icon">
    ...
    <div class="lazy-bg bg-overlay position-absolute z-index-1 w-100 h-100  " data-bg-src="assets/images/hero-slider/hero-slider-05.jpg">
    </div><div data-animate="fadeInDown" class="hero-creative-dots position-absolute bottom-0 mb-7 start-50 translate-middle-x"><span class="fs-5 fw-semibold text-white px-5 ">01.</span><span class="fs-5 fw-semibold text-white px-5 active">02.</span><span class="fs-5 fw-semibold text-white px-5 ">03.</span></div></div>
    <div class="vh-100 d-flex align-items-center">
    <div class="z-index-2 container container-xxl py-21 pt-xl-10 pb-xl-11">
    <div class="hero-content text-start">
    <div data-animate="fadeInDown">
    <p class="text-white mb-8 fw-semibold fs-4">New Arrivals</p><h1 class="mb-15 text-white hero-title-2 fw-500">Cleanser<br>Concentrate</h1>
    </div>
    <a href="#" data-animate="fadeInUp" class="pb-2 bg-transparent fw-semibold text-decoration-none hero-link btn btn-link p-0 text-white">
    Discover Now
    <svg class="icon">
    ...
    <div class="lazy-bg bg-overlay position-absolute z-index-1 w-100 h-100  " data-bg-src="assets/images/hero-slider/hero-slider-06.jpg">
    </div><div data-animate="fadeInDown" class="hero-creative-dots position-absolute bottom-0 mb-7 start-50 translate-middle-x"><span class="fs-5 fw-semibold text-white px-5 ">01.</span><span class="fs-5 fw-semibold text-white px-5 ">02.</span><span class="fs-5 fw-semibold text-white px-5 active active-last">03.</span></div></div>
    </div>
    </section>
    <section id="our_best_sellers_1">
    <div class="pt-14 pb-14 pt-lg-19 pb-lg-16">
    <div class="container container-xxl mb-13 d-xl-flex">
    <div class="flex-grow-1 text-left" data-animate="fadeInUp"><h2 class="mb-5">Our Bestsellers</h2>
    <p class="fs-18px mb-0 mw-xl-40 mw-lg-50 mw-md-75">Looking for something specific? Shop by category to find your perfect piece of jewellery!</p></div>
    </div>
    <div class="container-fluid mb-4">
    <div class="slick-slider our-best-seller-4" data-slick-options="{&#34;arrows&#34;:true,&#34;centerMode&#34;:true,&#34;centerPadding&#34;:&#34;calc((100% - 1440px) / 2)&#34;,&#34;dots&#34;:true,&#34;infinite&#34;:true,&#34;responsive&#34;:[{&#34;breakpoint&#34;:1200,&#34;settings&#34;:{&#34;arrows&#34;:false,&#34;dots&#34;:false,&#34;slidesToShow&#34;:3}},{&#34;breakpoint&#34;:992,&#34;settings&#34;:{&#34;arrows&#34;:false,&#34;dots&#34;:false,&#34;slidesToShow&#34;:2}},{&#34;breakpoint&#34;:576,&#34;settings&#34;:{&#34;arrows&#34;:false,&#34;dots&#34;:false,&#34;slidesToShow&#34;:1}}],&#34;slidesToShow&#34;:4}"><div data-animate="fadeInUp">
    ...
    <div class="text-left">
    <p class="fs-15px mb-6 ls-1 text-body-emphasis fw-semibold">NEW COLLECTION</p><h2 class="fs-20 w-md-50 w-lg-100 w-xl-80 mb-4 me-7 me-md-25">Discover Our Autumn Skincare</h2>
    <p class="fs-18px mb-0 text-body-calculate">Made using clean, non-toxic ingredients, our products are designed for everyone.</p></div>
    ...
    <p class="fs-15px mb-6 ls-1 text-body-emphasis fw-semibold">SHOP BY CATEGORIES</p><h2 class="mb-6">Because You Need Time for Yourself. <br> Blend Beauty in You</h2></div>
    <div class="row mt-13">
    ...
    <div class="card border-0">
    <a href="#" class="hover-shine img-scale overflow-hidden">
    <img class="lazy-image card-img-top img-scale-change img-fluid light-mode-img" src="#" data-src="./assets/images/shop/product-cate-2.jpg" width="545" height="694" alt="Skincare">
    <img class="lazy-image dark-mode-img card-img-top img-scale-change img-fluid" src="#" data-src="./assets/images/shop/product-cate-white-2.jpg" width="545" height="694" alt="Skincare">
    </a>
    <div class="card-body text-center px-0 py-7">
    ...
    <div class="card border-0">
    <a href="#" class="hover-shine img-scale overflow-hidden">
    <img class="lazy-image card-img-top img-scale-change img-fluid light-mode-img" src="#" data-src="./assets/images/shop/categories-03.jpg" width="545" height="545" alt="Accessories">
    <img class="lazy-image dark-mode-img card-img-top img-scale-change img-fluid" src="#" data-src="./assets/images/shop/categories-white-03.jpg" width="545" height="545" alt="Accessories">
    </a>
    <div class="card-body text-center px-0 py-7">
    ...
    <div class="card border-0">
    <a href="#" class="hover-shine img-scale overflow-hidden">
    <img class="lazy-image card-img-top img-scale-change img-fluid light-mode-img" src="#" data-src="./assets/images/shop/categories-04.jpg" width="545" height="694" alt="Haircare">
    <img class="lazy-image dark-mode-img card-img-top img-scale-change img-fluid" src="#" data-src="./assets/images/shop/categories-white-04.jpg" width="545" height="694" alt="Haircare">
    </a>
    <div class="card-body text-center px-0 py-7">
    ...
    <a href="https://templates.g5plus.net/shop/shop-layout-v1.html" target="_blank" class="btn btn-outline-dark">
    Shop All Products
    </a>
    </div>
    </section>
    ...
    <img class="lazy-image img-fluid light-mode-img" src="#" data-src="./assets/images/Countdown/Countdown-01.png" width="774" height="640" alt="Countdown">
    <img class="lazy-image dark-mode-img img-fluid" src="#" data-src="./assets/images/Countdown/Countdown-white-01.png" width="774" height="640" alt="Countdown">
    <div class="lable-sale-countdown fw-nomal py-9 px-9 d-none fs-5 bg-primary rounded-circle d-xl-flex align-items-center justify-content-center flex-column text-white position-absolute">
    Save<span class="fs-23px fw-semibold">$19.00</span></div>
    </div>
    <div class="col-lg-5 py-lg-0 py-13" data-animate="fadeInUp">
    <div class="text-left">
    <p class="fs-15px mb-6 ls-1 text-body-emphasis fw-semibold">SPECIAL OFFER <span class="badge bg-primary fs-15px fw-500 ms-4">-20%</span></p><h2 class="mb-6">Mountain Pine Bath Oil</h2>
    <p class="fs-18px mb-4 me-md-25 me-lg-0 me-xl-20 text-body-calculate">Made using clean, non-toxic ingredients, our products are designed for everyone.</p></div>
    ...
    <li class="list-inline-item"><a class="text-reset text-decoration-none text-primary-hover" href="#" title="Life style">Life style</a></li><li class="border-start ps-5 ms-5 list-inline-item">Jan 19th, 2021</li></ul>
    ...
    <div class="mx-auto mb-11 text-center" style="max-width:500px" data-animate="fadeInUp"><h3 class="mb-6">Stay Up to Date with All News and Exclusive Offers</h3></div>
    ...
    I accept the <a href="#" class="text-decoration-none text border-bottom">terms & conditions</a> and <a href="#" class="text-decoration-none border-bottom">the data protection</a>
    </label>
    </div>
    </div>
    </form>
