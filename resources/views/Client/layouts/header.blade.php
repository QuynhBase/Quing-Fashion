    ...
    <div class="bg-primary bg-opacity-15">
        <div class="container-xxl container d-flex py-4">
            ...
            <div class="w-100 text-center">
                <p class="mb-0 fs-14px fw-bold text-primary text-uppercase">Free shipping on all U.S. orders $50+</p>
            </div>
            <div class="w-50 d-none d-lg-block">
                <div class="d-flex align-items-center justify-content-end">
                    <div class="dropdown me-10">
                        <span class="d-inline-block me-3"><img src="../assets/images/header/flag.html" alt></span>
                        <button
                ...
                <div class="d-flex d-xl-none w-100">
                    ...
                    <div class="d-flex mx-auto">
                        <a href="index-2.html" class="navbar-brand px-8 py-4 mx-auto">
                            <img class="light-mode-img" src="{{asset('theme/assets/images/others/logo.png')}}" width="179"
